import { Escola, Visita, Segmento, StatusMeta, Coordenador, DadosNivel, MatriculaDetalhada, ItemAcompanhamento, DadosEducacionais } from './types.ts';

// Helper para criar dados vazios
export const createEmptyNivel = (): DadosNivel => ({
  turmas: { integral: 0, manha: 0, tarde: 0 },
  alunos: { integral: 0, manha: 0, tarde: 0 }
});

export const createEmptyMatriculaDetalhada = (): MatriculaDetalhada => ({
  infantil: {
...
export const createEmptyDadosEducacionais = (): DadosEducacionais => ({
